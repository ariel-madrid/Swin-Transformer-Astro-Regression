...
def prepare_dataloaders(config, logger, NpyDataset):
    train_transforms = transforms.Compose([
        ...
        # Rota la imagen en un ángulo aleatorio entre -20 y 20 grados.
        # La rotación puede crear píxeles vacíos en las esquinas, que se rellenan con 0.
        # Esto es generalmente aceptable y actúa como una forma adicional de regularización.
        transforms.RandomRotation(degrees=20),
    ])


    # Crear el dataset completo
    train_dataset = NpyDataset("/home/aargomedo/TESIS/Preprocesar/img_stdnorm_3params_norm_small/train",None)
    val_dataset = NpyDataset("/home/aargomedo/TESIS/Preprocesar/img_stdnorm_3params_norm_small/val",None)
    test_dataset = NpyDataset("/home/aargomedo/TESIS/Preprocesar/img_stdnorm_3params_norm_small/test",None)
