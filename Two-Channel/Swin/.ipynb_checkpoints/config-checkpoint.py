...
# Dropout rate
_C.MODEL.DROP_RATE = 0.12773602893862193
# Drop path rate
_C.MODEL.DROP_PATH_RATE = 0.20604643075719772
# Label Smoothing
...
_C.TRAIN.WEIGHT_DECAY = 0.1808300275487069
_C.TRAIN.BASE_LR = 0.00042051682835902055
_C.TRAIN.WARMUP_LR = 1e-5
_C.TRAIN.MIN_LR = 1e-5
_C.TRAIN.CLIP_GRAD = 4.134493134093158
