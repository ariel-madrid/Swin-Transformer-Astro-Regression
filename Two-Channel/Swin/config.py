...
# Model type
_C.MODEL.TYPE = 'swin'
#_C.MODEL.TYPE = 'conv_vit'
# Model name
_C.MODEL.NAME = 'swin_tiny'
# Pretrained weight from checkpoint, could be imagenet22k pretrained weight
# could be overwritten by command line argument
_C.MODEL.PRETRAINED = '/home/aargomedo/TESIS/Modelos/Two-Six/swin_tiny/default/skymodel_weights.pth'
# Checkpoint to resume, could be overwritten by command line argument
_C.MODEL.RESUME = ''
# Number of classes, overwritten in data preparation
_C.MODEL.NUM_CLASSES = 6
# Dropout rate
_C.MODEL.DROP_RATE = 0.23598685546230275
# Drop path rate
_C.MODEL.DROP_PATH_RATE = 0.11385782487431799 #0.2 #0.20604643075719772
# Label Smoothing
...
_C.TRAIN.BASE_LR = 0.0004942792699844937
_C.TRAIN.WARMUP_LR = 1e-5
_C.TRAIN.MIN_LR = 1e-5 #1e-5
_C.TRAIN.CLIP_GRAD = 1.885607182700304
